...
public class QueryServlet extends KEUIServlet {
	...
	private static final String SUGGEST_PEOPLE_TYPE = "suggestPeople";
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			if (PEOPLE_TYPE.equals(type) || KEYWORD_TYPE.equals(type) || TIMELINE_TYPE.equals(type) || ITEM_TYPE.equals(type)) {
				...
				else if (TIMELINE_TYPE.equals(type)) {
				...
				else if (ITEM_TYPE.equals(type)) {
					String requestMsg = msgUtils.getKEUIItemsMessage(props, requestId);
					String responseMsg = getKEUIResponse(requestMsg, requestId);
					resultJSon = msgUtils.parseKEUIItemsRespose(responseMsg);
				} 
				else {	// keywords
				...
				String responseMsg = getApiResponse(requestMsg);
				resultJSon = msgUtils.parseIssueDetailsMsg(responseMsg);
			} 
			else if (SUGGEST_PEOPLE_TYPE.equals(type)) {
	...
	private String getApiResponse(String requestMsg) {
